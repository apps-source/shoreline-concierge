export const featuredActivityTypes = [
  'Dolphin cruises',
  'Boat tours',
  'Fishing charters',
  'Snorkeling trips',
...
export const coastalDestinationTiers = [
  {
    title: 'Most Popular Coastal Destinations',
    description: 'These are some of the most searched beach destinations based on broad travel interest and destination demand signals.',
    destinations: [
      'Myrtle Beach',
      'Clearwater',
      'Virginia Beach',
...
export const howItWorksSteps = [
  {
    title: 'Search by destination, dates, or occasion',
  ...
  },
  {
    ...
    description: 'When something fits your trip, click through to a trusted booking partner to confirm the experience.'
  }
]
